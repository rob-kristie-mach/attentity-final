...
<header class="sticky shadow-md top-0 inset-x-0 flex flex-wrap sm:justify-start sm:flex-nowrap z-50 w-full text-sm py-3 sm:py-0 bg-colors-white">
    <nav class="relative max-w-[75rem] w-full mx-auto px-4 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8" aria-label="Global">
      <div class="flex items-center justify-between">
        <a class="flex-none text-xl font-semibold dark:text-white" href="/" ><img src="/images/attentity_logo.svg" alt="Attentity"/></a>
        <div class="sm:hidden">
      ...
      <div id="navbar-collapse-with-animation" class="hs-collapse hidden overflow-hidden transition-all duration-300 basis-full grow sm:block">
        <div class="flex flex-col gap-y-4 gap-x-0 mt-5 sm:flex-row sm:items-center sm:justify-end sm:gap-y-0 sm:gap-x-7 sm:mt-0 sm:pl-7">
          <a class="font-medium text-xs sm:py-6 dark:text-blue-500" href="/graph/">Graph</a>
          <a class="font-medium text-xs hover:text-colors-font sm:py-6 dark:text-colors-font dark:hover:text-gray-500" href="/data/">Data</a>
          <a class="font-medium text-xs hover:text-colors-font sm:py-6 dark:text-colors-font dark:hover:text-gray-500" href="/data-licensing/">Data Licensing</a>
          <a class="font-medium text-xs hover:text-colors-font sm:py-6 dark:text-colors-font dark:hover:text-gray-500" href="/content-hub/">Content Hub</a>
          <a class="font-medium btn btn-primary" href="/set-up-demo/">Set Up A Demo</a>
        </div>
      </div>
    </nav>
  </header>
